<%-- Document : tablacredito Created on : 22 feb 2022, 22:10:03 Author : PC --%>
                ...
                <tbody>
                  <% ArrayList<Credito> listado = new ArrayList<Credito>();
                      ...
                      <form action="Servletcreditos" method="post">
                        <tr>
                          <th scope="row"><input type="type" value="<%=lista.getCodigo()%>" name="acod" class="text-black"></th>
                          <td><input type="text" value="<%=lista.getDocumento()%>" name="adoc" class="text-black"></td>
                          <td><input type="text" value="<%=lista.getCodlinea()%>" name="acod" class="text-black"></td>
                          <td><input type="text" value="<%=lista.getMonto()%>" name="amon" class="text-black"></td>
                          <td><input type="date" value="<%=lista.getFecha()%>" name="afec" class="text-black"></td>
                          <td><input type="text" value="<%=lista.getPlazo()%>" name="apla" class="text-black"></td>
                          <td>
