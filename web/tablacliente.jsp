          ...
          <table class="table table-dark table-striped">
            ...
            <form action="Servletcliente" method="post">
              <tr>
                  ...
                  <td><input type="text" value="<%=lista.getNombre()%>" name="anom" class="text-black"></td>
                  <td><input type="text" value="<%=lista.getApellido()%>" name="aape" class="text-black"></td>
                  <td><input type="text" value="<%=lista.getCorreo()%>" name="aema" class="text-black"></td>
                  <td><input type="text" value="<%=lista.getNumero()%>" name="anum" class="text-black"></td>
                  <td><input type="text" value="<%=lista.getSexo()%>" name="sexo" class="text-black"></td>
                  <td><input type="date" value="<%=lista.getFecnac()%>" name="fecnac" class="text-black"></td>
                <td>
